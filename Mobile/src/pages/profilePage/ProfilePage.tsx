import { Button, FlatList, Image, RefreshControl, SafeAreaView, ScrollView, Text, Touchable, View } from "react-native";
...
export default function({navigation}){
    ...
    return(
        ...
        <SafeAreaView style={Style.container}>
            <ScrollView  refreshControl={<RefreshControl tintColor="white" refreshing={refreshing} onRefresh={onRefresh} />}  showsVerticalScrollIndicator={false}>
