...
const Post = ({item, navigation, likes, getUserLikes, fetchData}) => {
    ...
    async function handleRemoveLikePost(){
        ...
        await axios.post(BASE_URL + "post/remove-like", post, {headers: {"Authorization": `Bearer ${token}`}})
        .then((res) => {
            fetchData();
            getUserLikes();
        }).catch((error)=>console.error(error))
        ...
        <View style={Style.container}>
            ...
            <View style={Style.info}>
                <View style={Style.likeContainer}>
                    <TouchableOpacity onPress={isLiked() ? handleRemoveLikePost : handleLikePost}>
